    ...
    public partial class BorneEntreeVM : ObservableObject
    {
        ...
        private void DownloadTicketPDF()
        {
            ...
            using (PdfDocument document = new PdfDocument())
            {
                ...
                gfx.DrawString("Hôpital de Chicoutimi", fontNormal, XBrushes.Black, 
                    new XPoint((page.Width.Point)/ 2, (page.Height.Point / 2) + 70));
                gfx.DrawString($"Date et Heure d'Arrivée: {TicketActuel.TempsArrive:dd/MM/yyyy HH:mm:ss}", fontNormal, XBrushes.DarkBlue,
                    new XPoint((page.Width.Point - gfx.MeasureString($"Date et Heure d'Arrivée: {TicketActuel.TempsArrive:dd/MM/yyyy HH:mm:ss}", fontNormal).Width) / 2, (page.Height.Point / 2) + 60));
